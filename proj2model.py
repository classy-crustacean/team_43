...
m_p = p*1000/(2.688*10^25) # Smog density times 1000L divided by 1000L/22.4L/mole * 6.022*10^23 particles/mole
g = 9.81
re = 1*10**-6
c_d = 24/re
p_a = 0.9093
...
a = (-(m_p * g) - ((1/2)(c_d * (p_s - p_a) * a * u_r * u__r)) + ((1/6) * (math.pi) * (p) * g * (d**3)) + (voltage) / (dist_pp))) / (m_p)
